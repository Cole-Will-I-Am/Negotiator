// Crypto + identity for the negotiator-api Worker: opaque D1-backed sessions, anonymous
// device accounts, and (optional) Sign in with Apple. Ported from RUNG's auth.js, trimmed
// of the run-anchor anti-cheat (negotiator is server-stateful — no client-replayed runs).
...
// ---- Sign in with Apple: verify the identity token (RS256). Optional in build 1. ----
