...
struct PhasePill: View {
    let phase: Phase
    // Dark-friendly tint (the pill sits on the dark chat backdrop; Guarded reads light, not muddy).
    private var color: Color {
        switch phase {
        case .cold:     return Palette.paper.opacity(0.82)
        case .warm:     return Palette.amber
        case .cornered: return Palette.gold
        }
    }
    var body: some View {
        HStack(spacing: 6) {
